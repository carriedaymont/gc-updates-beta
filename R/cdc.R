...
#' df_wide <- longwide(clean_df) # convert to wide format for ext_bmiz
                      ...
                      ref.data.path = "")
{
  ...
  if (!requireNamespace("dplyr", quietly = TRUE) ||
    ...
    stop("ext_bmiz() requires the 'dplyr' and 'labelled' packages. Install them with install.packages(c(\"dplyr\", \"labelled\")).")
  }
  ...
  setnames(adj_bmi_met, c("sexn", "mref", "sref"))
