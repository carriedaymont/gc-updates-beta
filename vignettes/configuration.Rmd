...
| `imperial` WEIGHTKG | `abs((v.orig * 2.20462262) %% 1) < 0.01` | `cleanchild` Child Step 6 (`cf_detail`) | Whole pounds detection (design-aid column) |
| `imperial` HEIGHTCM / HEADCM | `abs((v.orig / 2.54) %% 0.5) < 0.01` | `cleanchild` Child Step 6 (`cf_detail`) | Whole or half inches detection (design-aid column) |
